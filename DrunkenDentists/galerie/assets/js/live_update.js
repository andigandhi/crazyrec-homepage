    ...
    switch(path){
        ...
        case "nonCSS.galleryAuthor.value":
            ...
            if(newValue != ""){
                if(storedGalleryAuthorURL != ""){
                    $el.html('<a id="galleryAuthorURL" href="../../../../galerie/assets/js/' + storedGalleryAuthorURL + '" target="_blank">by ' + newValue + '</a>');
                }
                else {
                    $el.html("by " + newValue);
                }
        ...
        case "nonCSS.galleryAuthor.url":
            ...
            if(newValue == ""){
                ...
                newAuthorContent = '<a id="galleryAuthorURL" href="../../../../galerie/assets/js/' + newValue + '" target="_blank">' + currentAuthorContent + '</a>';
            }
